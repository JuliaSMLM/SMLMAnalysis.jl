...
5-6. Render — 3 pre-BaGoL renders (Gaussian, Histogram, Circle)
7. BaGoL — Bayesian grouping of localizations into emitters
8-9. Render — post-BaGoL Gaussian + overlay (locs white, MAP-N red)
...
# --- Step 4: Pre-BaGoL Render (Gaussian) ---
println("="^60)
println("Step 4: Render (Gaussian)")
println("="^60)
...
# --- Step 5: Pre-BaGoL Render (Histogram) ---
println("="^60)
println("Step 5: Render (Histogram)")
println("="^60)
...
# --- Step 6: Pre-BaGoL Render (Circle) ---
println("="^60)
println("Step 6: Render (Circle)")
println("="^60)
...
# --- Step 8: Post-BaGoL Gaussian Render ---
println("="^60)
println("Step 8: Post-BaGoL Render (Gaussian)")
println("="^60)
...
# --- Step 9: Overlay — localizations (white) + MAP-N emitters (red) ---
println("="^60)
println("Step 9: Overlay (locs + MAP-N emitters)")
println("="^60)

overlay_dir = joinpath(OUTPUT_DIR, "09_overlay")
mkpath(overlay_dir)
overlay_path = joinpath(overlay_dir, "overlay.png")

render([smld, smld_bagol];
    colors = [:white, :red],
...
println()
println("  Key outputs:")
println("    04_render/render.png          — Pre-BaGoL Gaussian")
println("    05_render/render.png          — Pre-BaGoL Histogram")
println("    06_render/render.png          — Pre-BaGoL Circle")
println("    07_bagol/                     — BaGoL diagnostics + reports")
println("    08_render/render.png          — Post-BaGoL Gaussian (MAP-N)")
println("    09_overlay/overlay.png        — Locs (white) + MAP-N (red) overlay")
